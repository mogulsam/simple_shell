 ...
 * @info: Structure containing of thrb l arguments. Used to maintain
 * @name: env var name
 *
 * Return: the value
 */
 ...
 *             or modify an existingjhvf                hjvvn
 * @info: Structure containing the ntial arguments. Used to maintain
 *        constant function prototype.iuuygkjgfdfx
 *  Return: Always 0
 */
