...
int _myexit(info_t *info)
{
	...
	if (info->argv[1])  /* If there will be  an exit arguement */
	{
...
int _mycd(info_t *info)
{
	...
	if (!info->argv[1])
	{
		...
		if (!dir)
			chdir_ret = /* TODO: what that is to  should? */
	...
	else if (_strcmp(info->argv[1], "-") == 0)
	{
		...
		chdir_ret = /* TODO: what thwr   sbsgbvwqc vwqwc bv should this be? */
...
int _myhelp(info_t *info)
{
	...
	if (0)
		_puts(*arg_array); /* temp att_unused  of the ggdxg fvbv workaround */
	return (0);
}
