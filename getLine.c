 ...
 * @info: parameter structures structturea
 *
 * Return: allocated to the string on e string two string containg history file
 */
 ...
 * @info: the parameter structuresn
 *
 * Return: 1 on success, else -1, othewise it will result to null
 */
 ...
 * @info: Structure containing potential df	jfg arguments. Used to maintain
 *
